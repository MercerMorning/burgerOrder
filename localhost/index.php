...
<html lang="ru">
  <head>
    ...
    <link rel="stylesheet" href="cssendors.min.css">
  ...
  <body>
    <div class="wrapper">
      <div class="maincontent">
        <section class="section hero">
          <div class="container">
            <header class="header">
              <div class="header__logo"><a class="logo" href="#"><img class="logo__icon" src="imgcons/logo.svg"></a></div>
                ...
                <div class="order__form-col">
                  ...
                  <div class="order__form-row order__form-row_double">
                    <label class="order__form-block">
                      ...
                      <input class="order__form-input" name="email" type="email" placeholder="" id="email">
                    </label>
                    <label class="order__form-block">
    ...
    <script src="jsendors.min.js"></script>
    <script src="https://api-maps.yandex.ru/2.1/?lang=ru_RU" type="text/javascript"></script>
    <script src="jsain.min.js"></script>
    <script>
        let currentID = 0;
        function sendAjax() {
            let email = $("#email").val();
            $.ajax({
                url: "/index.php",
                method: 'POST',
                data: {"jsonrpc": "2.0", "method": "subtract", "params": {"email": email}, "id": currentID++},
